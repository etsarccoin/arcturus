...
urlpatterns = [
    ...
    path("recretaion/",views.recretaion,name="recreation"),
    path("edittravel/",views.travel_edit,name="edittravel"),
    path("editabout/",views.about_edit,name="editabout"),
    path("editwhitepage/",views.white_page_edit,name="whitepage"),
