...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='referencecalculation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('main_mail', models.EmailField(blank=True, max_length=254)),
                ('mail1', models.EmailField(blank=True, max_length=254)),
                ('mail2', models.EmailField(blank=True, max_length=254)),
                ('mail3', models.EmailField(blank=True, max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='referencecodemodel',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mail', models.EmailField(max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Time', models.DateTimeField(default=datetime.datetime(2019, 11, 16, 17, 3, 22, 45347))),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('refercode', models.CharField(blank=True, max_length=8)),
